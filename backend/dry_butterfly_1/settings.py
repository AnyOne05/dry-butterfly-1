"""
Django settings for dry_butterfly_1 project.
...
ROOT_URLCONF = 'dry_butterfly_1.urls'
...
WSGI_APPLICATION = 'dry_butterfly_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Dry Butterfly Support <support@dry-butterfly-1.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_butterfly_1 API",
    "DESCRIPTION": "API documentation for dry_butterfly_1 App",
    "VERSION": "v1",
}
